...
_L9:
    ...
    public void onActivityResult(int i, int j, Intent intent)
    {
        ...
        {
            int i1 = k - 1;
            if (mFragments.mActive == null || i1 < 0 || i1 >= mFragments.mActive.size())
            {
            ...
            Fragment fragment = (Fragment)mFragments.mActive.get(i1);
            if (fragment == null)
            {
...
_L3:
    ...
    public final Object onRetainNonConfigurationInstance()
    {
        ...
        if (mAllLoaderManagers != null)
        {
            ...
            for (int k = j - 1; k >= 0; k--)
            {
                aloadermanagerimpl[k] = (LoaderManagerImpl)mAllLoaderManagers.b(k);
            }
    ...
    protected void onStart()
    {
        ...
        if (mAllLoaderManagers != null)
        {
            ...
            for (j = i - 1; j >= 0; j--)
            {
                aloadermanagerimpl[j] = (LoaderManagerImpl)mAllLoaderManagers.b(j);
            }
