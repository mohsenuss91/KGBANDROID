...
public class AnalyticsSQLiteHelper extends SQLiteOpenHelper
{
    ...
    {
        Log.debug(com/inmobi/commons/analytics/db/AnalyticsSQLiteHelper.getName(), (new StringBuilder("Upgrading database from version ")).append(i).append(" to ").append(j).append(", which will destroy all old data").toString());
