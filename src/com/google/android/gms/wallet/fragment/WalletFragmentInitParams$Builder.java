...
public final class <init>
{
    ...
    public final aky setAccountName(String s)
    {
        WalletFragmentInitParams.a(aky, s);
        return this;
    }

    public final aky setMaskedWallet(MaskedWallet maskedwallet)
    {
        WalletFragmentInitParams.a(aky, maskedwallet);
        return this;
    }

    public final aky setMaskedWalletRequest(MaskedWalletRequest maskedwalletrequest)
    {
        WalletFragmentInitParams.a(aky, maskedwalletrequest);
        return this;
    }

    public final aky setMaskedWalletRequestCode(int i)
    {
