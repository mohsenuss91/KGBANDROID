...
public final class dz
{
    ...
    public static dv a(Context context, dt dt1, String s)
    {
        ...
        {
            ev.D((new StringBuilder("Could not parse the mediation config: ")).append(jsonexception.getMessage()).toString());
            return new dv(0);
        }
        l = -1L;
...
_L2:
        ...
        if (ev.p(2))
        {
            ...
            ev.C((new StringBuilder("Ad Request JSON: ")).append(s2).toString());
        }
        s1 = ep.o(hashmap).toString();
        return s1;
        JSONException jsonexception;
        jsonexception;
        ev.D((new StringBuilder("Problem serializing ad request to JSON: ")).append(jsonexception.getMessage()).toString());
        return null;
