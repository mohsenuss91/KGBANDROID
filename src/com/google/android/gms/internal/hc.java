    ...
    implements com.google.android.gms.common.api.Api.a, hd.b
{
    ...
    public transient hc(Context context, Looper looper, com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks connectioncallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener onconnectionfailedlistener, String as[])
    {
        FZ = new ArrayList();
        Gb = 1;
        Gd = false;
    ...
    public void connect()
    {
        ...
        } else
        {
            ...
            {
                Log.e("GmsClient", (new StringBuilder("unable to connect to service: ")).append(bp()).toString());
    ...
    private class h extends b
    {
        ...
        protected final void b(Boolean boolean1)
        {
            ...
            default:
                ...
                if (Gk != null)
                {
                    pendingintent = (PendingIntent)Gk.getParcelable("pendingIntent");
                } else
                {
                    pendingintent = null;
                }
                ...
                hc.a(Gf, 1);
                hc.a(Gf, null);
                hc.a(Gf).a(new ConnectionResult(statusCode, pendingintent));
                return;

            case 0: // '\0'
                try
                {
                    s = Gl.getInterfaceDescriptor();
                    if (Gf.bq().equals(s))
                    {
                        hc.a(Gf, Gf.x(Gl));
                        if (hc.c(Gf) != null)
