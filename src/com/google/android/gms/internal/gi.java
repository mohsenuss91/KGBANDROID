...
label0:
    ...
    protected final gm G(IBinder ibinder)
    {
    ...
    private class _cls1 extends gn.a
    {
        ...
        private void b(long l, int k)
        {
            ...
            {
                d1 = (com.google.android.gms.common.api.a.d)gi.h(BZ).remove(Long.valueOf(l));
            }
            if (d1 != null)
            {
                d1.a(new Status(k));
