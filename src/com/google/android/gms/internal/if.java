    ...
    implements SafeParcelable
{
        ...
        if (!ic1.b(class1))
        {
            ...
            do
            {
                ...
                if (class2 != null)
                {
                    ...
                    {
                        throw new IllegalStateException((new StringBuilder("Could not instantiate an object of type ")).append(a1.fJ().getCanonicalName()).toString(), instantiationexception);
                    }
                    catch (IllegalAccessException illegalaccessexception)
                    {
                        throw new IllegalStateException((new StringBuilder("Could not access object of type ")).append(a1.fJ().getCanonicalName()).toString(), illegalaccessexception);
                    }
                }
            } while (true);
        }
    ...
    private void a(StringBuilder stringbuilder, hz.a a1, Parcel parcel, int i)
    {
        ...
        {
        default:
            throw new IllegalArgumentException((new StringBuilder("Unknown field out type = ")).append(a1.fA()).toString());
...
_L4:
    ...
    ic fU()
    {
        ...
        {
        default:
            throw new IllegalStateException((new StringBuilder("Invalid creation type: ")).append(Ho).toString());
