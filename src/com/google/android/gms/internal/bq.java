    ...
    implements br.a
{
    ...
    private void a(bp bp1)
    {
        ...
        {
            ev.c("Could not request ad from mediation adapter.", remoteexception);
        }
        g(5);
        return;
        if (nD.md)
    ...
    private bv aK()
    {
        ev.B((new StringBuilder("Instantiating mediation adapter: ")).append(nA).toString());
        bv bv1;
        try
        {
            bv1 = kz.m(nA);
        ...
        {
            ev.a((new StringBuilder("Could not instantiate mediation adapter: ")).append(nA).toString(), remoteexception);
            return null;
        }
        return bv1;
    }
    ...
    public final br b(long l, long l1)
    {
        br br1;
        synchronized (lq)
        {
            ...
            bp bp1 = new bp();
            eu.ss.post(new _cls1(bp1));
            a(l2, nB, l, l1);
            br1 = new br(nC, nF, nA, bp1, nG);
        }
        return br1;
    }
