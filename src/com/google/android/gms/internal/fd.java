...
_L4:
    ...
    {
        ev.z((new StringBuilder("JavascriptAdWebViewClient::onLoadResource: ")).append(s).toString());
        if (!F(s))
        {
    ...
    {
        ev.z((new StringBuilder("JavascriptAdWebViewClient::onPageFinished: ")).append(s).toString());
        if (!sR)
        {
            sS.bj();
            sR = true;
    ...
    {
        ev.z((new StringBuilder("JavascriptAdWebViewClient::shouldOverrideUrlLoading: ")).append(s).toString());
        if (F(s))
        {
