    ...
    implements bb, be, bg, bo, cj, cm, dn.a, ek, u
{
    ...
    private boolean kD;
    private final ComponentCallbacks kE = new _cls1();
    private final bu kz;
    ...
    {
        ev.D((new StringBuilder("Failed to load ad: ")).append(i).toString());
        if (kA.kP == null)
        {
    ...
    private boolean b(eg eg1)
    {
        if (eg1.qd)
        {
            ...
            try
            {
                view1 = (View)e.e(eg1.nL.getView());
            }
            catch (RemoteException remoteexception1)
            {
                ev.c("Could not get View from mediation adapter.", remoteexception1);
                return false;
            }
            view2 = kA.kK.getNextView();
            if (view2 != null)
            {
                kA.kK.removeView(view2);
            }
            try
            {
                b(view1);
            ...
            {
                ev.c("Could not add mediation view to view hierarchy.", throwable);
                return false;
            }
        } else
        if (eg1.rx != null)
        ...
        if (kA.kS != null)
        {
            View view = kA.kK.getNextView();
            if (view instanceof ey)
            {
                ((ey)view).a(kA.kM, kA.kR);
            } else
            if (view != null)
            {
    ...
    private dt.a c(aj aj1)
    {
        ...
        android.content.pm.PackageInfo packageinfo1 = kA.kM.getPackageManager().getPackageInfo(applicationinfo.packageName, 0);
...
_L1:
        ...
        if (!kA.kR.md && kA.kK.getParent() != null)
        {
            ...
            int i = ai1[0];
            int j = ai1[1];
            DisplayMetrics displaymetrics = kA.kM.getResources().getDisplayMetrics();
            int k = kA.kK.getWidth();
            int l = kA.kK.getHeight();
            android.content.pm.PackageManager.NameNotFoundException namenotfoundexception;
            String s;
            Bundle bundle1;
            int i1;
            if (kA.kK.isShown() && i + k > 0 && j + l > 0 && i <= displaymetrics.widthPixels && j <= displaymetrics.heightPixels)
            {
                i1 = 1;
            } else
            {
        ...
        kA.kT.f(aj1);
        bundle1 = ei.a(kA.kM, this, s);
        return new dt.a(bundle, aj1, kA.kR, kA.kL, applicationinfo, packageinfo, s, ei.rN, kA.kO, bundle1);
...
_L3:
    ...
    {
        cu cu1 = new cu(s, arraylist, kA.kM, kA.kO.st);
...
_L5:
        cv.a(kA.kM, kA.kO.sw, new cr(cu1, kA.kV, kA.kX, kA.kM));
        return;
...
_L3:
        ...
        if (!aj1.lT)
        {
            ev.B((new StringBuilder("Use AdRequest.Builder.addTestDevice(\"")).append(eu.o(kA.kM)).append("\") to get test ads on this device.").toString());
        }
        kB.cancel();
        kA.kZ = false;
        a1 = c(aj1);
...
_L5:
        ey ey2;
        ey ey3 = ey.a(kA.kM, kA.kR, false, false, kA.kN, kA.kO);
        ey3.bW().a(this, null, this, this, true, this, this);
        ey2 = ey3;
_L8:
        kA.kQ = dn.a(kA.kM, a1, kA.kN, ey2, kz, this);
        return true;
_L6:
        View view;
        ey ey1;
        ...
        ey1.a(kA.kM, kA.kR);
_L9:
        ey1.bW().a(this, this, this, this, false, this);
        ey2 = ey1;
...
_L7:
        ...
        ey1 = ey.a(kA.kM, kA.kR, false, false, kA.kN, kA.kO);
        if (kA.kR.me == null)
        {
            b(ey1);
        }
...
_L10:
    ...
    public void aa()
    {
        if (kA.kS != null)
        {
            ev.D((new StringBuilder("Mediation adapter ")).append(kA.kS.nM).append(" refreshed, but mediation adapters should never refresh.").toString());
        }
        c(true);
        af();
    }
    ...
    public void onAppEvent(String s, String s1)
    {
        ...
        RemoteException remoteexception;
        remoteexception;
        ev.c("Could not call the AppEventListener.", remoteexception);
        return;
    }
    ...
    public void showInterstitial()
    {
        ...
        {
            Window window = ((Activity)kA.kM).getWindow();
            Rect rect = new Rect();
            Rect rect1 = new Rect();
        ...
        ci1 = new ci(this, this, this, kA.kS.ow, kA.kS.orientation, kA.kO, kA.kS.qi, w1);
        cg.a(kA.kM, ci1);
    }
    ...
    private class c
    {
            ...
            implements h, Runnable
        {
            ...
            public final void a(int i, int j, int i1)
            {
                h h1 = (h)kJ.get();
                if (h1 != null)
                {
