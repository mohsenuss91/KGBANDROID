    ...
    implements android.os.Handler.Callback
{
    ...
    public final boolean a(String s, hc.f f)
    {
        HashMap hashmap = Gu;
        hashmap;
...
_L1:
        ...
        a1.B(lx.bindService(intent, a1.fs(), 129));
        Gu.put(s, a1);
_L7:
...
_L5:
        ...
        a1.B(lx.bindService(intent1, a1.fs(), 129));
          goto _L7
    }

    public final void b(String s, hc.f f)
    {
        HashMap hashmap = Gu;
        hashmap;
        JVM INSTR monitorenter ;
    ...
    private class a
    {
        ...
        public final void a(hc.f f)
        {
            Gx.add(f);
        }

        public final void b(hc.f f)
        {
            Gx.remove(f);
        }

        public final boolean c(hc.f f)
        {
