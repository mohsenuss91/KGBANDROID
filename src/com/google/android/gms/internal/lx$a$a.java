...
public final class nu extends mb
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            class a extends mb
            {
                ...
                public final boolean equals(Object obj1)
                {
                    if (obj1 != this)
                    {
                        ...
                        if (Double.doubleToLongBits(amv) != Double.doubleToLongBits(a1.amv))
                        {
                            return false;
                        }
                        if (Float.floatToIntBits(amw) != Float.floatToIntBits(a1.amw))
                        {
                            return false;
                        }
                        if (amx != a1.amx)
                        ...
                        if (!md.equals(amB, a1.amB))
                        {
                            return false;
                        }
                        if (!md.equals(amC, a1.amC))
                        {
                            return false;
                        }
                        if (!md.equals(amD, a1.amD))
                        {
                            return false;
                        }
                        if (!md.equals(amE, a1.amE))
                        {
                            return false;
                        }
                        if (!md.equals(amF, a1.amF))
                        {
                            return false;
                        }
                        if (amG != a1.amG)
            ...
            if (!ams.equals(nv.ams))
            {
                return false;
            }
            if (amU == null || amU.isEmpty())
            {
                if (nv.amU != null && !nv.amU.isEmpty())
                {
                    return false;
                }
            } else
            {
                return amU.equals(nv.amU);
            }
        }
        return true;
    }
