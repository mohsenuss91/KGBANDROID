...
_L2:
        ...
        cursor = null;
_L4:
        ev.D((new StringBuilder("Error remove oldest record")).append(sqliteexception.getMessage()).toString());
...
_L2:
        ...
        cursor = null;
_L5:
        ev.D((new StringBuilder("Error extracing purchase info: ")).append(sqliteexception.getMessage()).toString());
        if (cursor == null) goto _L2; else goto _L1
_L1:
        cursor.close();
          goto _L2
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        ev.D((new StringBuilder("Error getting record count")).append(sqliteexception.getMessage()).toString());
        if (cursor == null) goto _L2; else goto _L1
_L1:
        cursor.close();
          goto _L2
    ...
    private class a extends SQLiteOpenHelper
    {
        ...
        {
            ev.B((new StringBuilder("Database updated from version ")).append(i).append(" to version ").append(j).toString());
