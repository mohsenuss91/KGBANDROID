...
public final class lx extends mb
{
    ...
    public final boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            lx lx1 = (lx)obj;
            if (!md.equals(amo, lx1.amo))
            {
                return false;
            }
            if (amU == null || amU.isEmpty())
            {
                if (lx1.amU != null && !lx1.amU.isEmpty())
                {
                    return false;
                }
            } else
            {
                return amU.equals(lx1.amU);
            }
        }
        return true;
    }
                            ...
                            class a extends mb
                            {
                                ...
                                public final boolean equals(Object obj2)
                                {
                                    if (obj2 != this)
                                    {
                                        ...
                                        if (!amu.equals(a3.amu))
                                        {
                                            return false;
                                        }
                                        if (Double.doubleToLongBits(amv) != Double.doubleToLongBits(a3.amv))
                                        {
                                            return false;
                                        }
                                        if (Float.floatToIntBits(amw) != Float.floatToIntBits(a3.amw))
                                        {
                                            return false;
                                        }
                                        if (amx != a3.amx)
                                        ...
                                        if (!md.equals(amB, a3.amB))
                                        {
                                            return false;
                                        }
                                        if (!md.equals(amC, a3.amC))
                                        {
                                            return false;
                                        }
                                        if (!md.equals(amD, a3.amD))
                                        {
                                            return false;
                                        }
                                        if (!md.equals(amE, a3.amE))
                                        {
                                            return false;
                                        }
                                        if (!md.equals(amF, a3.amF))
                                        {
                                            return false;
                                        }
                                        if (amG != a3.amG)
                                        ...
                                        if (amU == null || amU.isEmpty())
                                        {
                                            if (a3.amU != null && !a3.amU.isEmpty())
                                            {
                                                return false;
                                            }
                                        } else
                                        {
                                            return amU.equals(a3.amU);
                                        }
                                    }
                                    return true;
                                }
