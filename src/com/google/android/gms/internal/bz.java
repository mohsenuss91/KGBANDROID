    ...
    implements MediationBannerListener, MediationInterstitialListener
{
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationbanneradapter, int i)
    {
        ...
        ev.z((new StringBuilder("Adapter called onAdFailedToLoad with error. ")).append(i).toString());
        try
        {
    ...
    {
        hn.ay("onAdFailedToLoad must be called on the main UI thread.");
        ev.z((new StringBuilder("Adapter called onAdFailedToLoad with error ")).append(i).append(".").toString());
        try
        {
            nR.onAdFailedToLoad(i);
            return;
