    ...
    implements SafeParcelable
{
    ...
    public String toString()
    {
        ...
        stringbuilder.append((new StringBuilder(", mAddress=")).append(YI).toString());
        stringbuilder.append((new StringBuilder(", mType=")).append(AQ).toString());
        stringbuilder.append((new StringBuilder(", mRole=")).append(alf).toString());
        stringbuilder.append((new StringBuilder(", mEnabled=")).append(alg).toString());
