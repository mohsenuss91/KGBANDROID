...
public final class GooglePlayServicesUtil
{
    ...
    {
        if (!iq.ga()) goto _L2; else goto _L1
_L1:
...
_L5:
        ...
        if (fragment == null)
        {
            ha1 = new ha(activity, intent, j);
        } else
        {
            ha1 = new ha(fragment, intent, j);
        }
        s = e(activity, i);
        if (s != null)
        {
            builder.setPositiveButton(s, ha1);
        }
        switch (i)
        {
        default:
...
_L4:
    ...
    abyte0
        ...
        int i = ij.aB(0x4d7808);
        if (ij.aB(packageinfo.versionCode) < i)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder("Google Play services out of date.  Requires 5077000 but found ")).append(packageinfo.versionCode).toString());
            return 2;
        }
...
_L1:
        ...
        if (bundle != null)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 5077000 but found ")).append(i).append(".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version\" android:value=\"@integer/google_play_services_version\" />").toString());
            }
        } else
        {
