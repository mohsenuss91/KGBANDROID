...
label0:
    ...
    public final DM addScope(Scope scope)
    {
        DE.add(scope.eK());
        return this;
    }
    ...
    public final DK setAccountName(String s)
    {
        yN = s;
        return this;
    }

    public final yN setGravityForPopups(int i)
    {
        DF = i;
        return this;
    }

    public final DF setHandler(Handler handler)
    {
    ...
    public final DC setViewForPopups(View view)
    {
        DG = view;
        return this;
    }

    public final DG useDefaultAccount()
    {
