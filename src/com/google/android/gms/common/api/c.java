    ...
    implements GoogleApiClient
{
    ...
    final GoogleApiClient.ConnectionCallbacks Ef = new _cls2();
    private final com.google.android.gms.internal.hd.b Eg = new _cls3();

    public c(Context context, Looper looper, gz gz1, Map map, Fragment fragment, Set set, Set set1)
    {
        DO = DN.newCondition();
        DU = 4;
        DV = 0;
        ...
        Api.b b1;
        Object obj;
        for (Iterator iterator2 = map.keySet().iterator(); iterator2.hasNext(); Eb.put(api.ew(), a(b1, obj, context, looper, gz1, Ef, new _cls4(b1))))
        {
...
_L2:
    ...
    private class _cls3
        implements com.google.android.gms.internal.hd.b
    {
