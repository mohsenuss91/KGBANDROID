    ...
    implements SafeParcelable
{
    ...
    public final boolean equals(Object obj)
    {
        if (this != obj)
        {
            ...
            if (mPriority != locationrequest.mPriority || Vi != locationrequest.Vi || Vj != locationrequest.Vj || Vk != locationrequest.Vk || UY != locationrequest.UY || Vl != locationrequest.Vl || Vm != locationrequest.Vm)
            {
                return false;
            }
        }
    ...
    public final int hashCode()
    {
        ...
        aobj[2] = Long.valueOf(Vj);
        aobj[3] = Boolean.valueOf(Vk);
        aobj[4] = Long.valueOf(UY);
        aobj[5] = Integer.valueOf(Vl);
        aobj[6] = Float.valueOf(Vm);
    ...
    public final String toString()
    {
        ...
        {
            long l = UY - SystemClock.elapsedRealtime();
