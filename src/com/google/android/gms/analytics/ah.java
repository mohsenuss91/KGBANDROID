...
_L5:
        ...
        try
        {
            httpentityenclosingrequest = e(ab1.dl(), url.getPath());
        }
        ...
        if (httpentityenclosingrequest == null) goto _L1; else goto _L3
_L3:
        ...
        q.t(mContext);
        httpresponse = wY.execute(httphost, httpentityenclosingrequest);
...
_L4:
        aa.D((new StringBuilder("Bad response: ")).append(httpresponse.getStatusLine().getStatusCode()).toString());
        return;
        try
        {
...
_L4:
        basichttpentityenclosingrequest.addHeader("User-Agent", wX);
...
_L2:
        ...
        if (aa.dk())
        {
            aa.D((new StringBuilder("No destination: discarding hit: ")).append(x1.df()).toString());
        } else
        {
