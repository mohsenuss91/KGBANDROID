...
public class Tracker
{
    ...
    void a(aj aj1)
    {
        ...
        if (xj.dD())
        {
            ...
            aa.C((new StringBuilder("[Tracker] session timeout loaded: ")).append(dt()).toString());
        }
        if (xj.dE())
        {
            enableAutoActivityTracking(xj.dF());
            aa.C((new StringBuilder("[Tracker] auto activity tracking loaded: ")).append(du()).toString());
        }
        if (xj.dG())
        {
            if (xj.dH())
