...
_L4:
        d d2;
        for (; !uj.isEmpty(); tR.a(d2.cM(), d2.cN(), d2.getPath(), d2.cO()))
        {
            d2 = (d)uj.poll();
...
_L11:
        ug.a(d1.cM(), d1.cN(), d1.getPath(), d1.cO());
_L13:
        uj.poll();
          goto _L5
_L12:
