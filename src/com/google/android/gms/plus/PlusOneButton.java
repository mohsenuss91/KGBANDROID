...
public final class PlusOneButton extends FrameLayout
{
    ...
    {
        String s = hq.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attributeset, true, false, "PlusOneButton");
        byte byte0;
    ...
    {
        String s = hq.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attributeset, true, false, "PlusOneButton");
        ...
        implements android.view.View.OnClickListener, OnPlusOneClickListener
    {
        ...
        {
            Intent intent = (Intent)PlusOneButton.a(abD).getTag();
            if (abC != null)
            {
                abC.onPlusOneClick(intent);
                return;
            } else
            {
