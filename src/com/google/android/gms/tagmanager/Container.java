...
public class Container
{
    ...
    private void a(cq.c c)
    {
        aew = c.getVersion();
        ag ag = bI(aew);
        a(new cs(mContext, c, aer, new a(null), new b(null), ag));
    }
    ...
    FunctionCallMacroCallback bF(String s)
    {
        ...
        synchronized (aet)
        {
            functioncallmacrocallback = (FunctionCallMacroCallback)aet.get(s);
        }
    ...
    FunctionCallTagCallback bG(String s)
    {
        ...
        synchronized (aeu)
        {
            functioncalltagcallback = (FunctionCallTagCallback)aeu.get(s);
        }
