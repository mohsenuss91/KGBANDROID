...
_L6:
        ...
        aobj[0] = Long.valueOf(((ap)arraylist2.get(j)).dg());
...
_L10:
        ...
        if (!TextUtils.isEmpty(ap1.lJ())) goto _L13; else goto _L12
_L12:
...
_L3:
    ...
    int dn()
    {
        ...
        if (l > 0x5265c00L + wR)
        {
            ...
            if (sqlitedatabase != null)
            {
                long l1 = aec.currentTimeMillis() - 0x9a7ec800L;
...
_L3:
        ...
        {
            if (wU && 0x36ee80L + wV > ca.a(agq).currentTimeMillis())
            {
...
_L1:
        ...
        implements da.a
    {
        ...
        {
            ca.a(agq, ap1.dg());
            bh.C((new StringBuilder("Permanent failure dispatching hitId: ")).append(ap1.dg()).toString());
        }
        ...
        public void c(ap ap1)
        {
            ...
            {
                ca.a(agq, ap1.dg());
                bh.C((new StringBuilder("Giving up on failed hitId: ")).append(ap1.dg()).toString());
                return;
            }
        }
