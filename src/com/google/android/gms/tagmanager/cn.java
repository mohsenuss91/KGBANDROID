    ...
    implements Runnable
{
    ...
    cn(Context context, String s, bm bm1, r r1)
    {
        ...
        aeq = s;
        agL = r1;
        agJ = (new StringBuilder("/r?id=")).append(s).toString();
        aeM = agJ;
        agM = null;
    }
    ...
    private void mc()
    {
        ...
        {
            bh.C((new StringBuilder("No change for container: ")).append(aeq).toString());
        }
        agK.i(j);
        bl1.close();
        ...
        bh.D((new StringBuilder("No data is retrieved from the given url: ")).append(s).append(". Make sure container_id: ").append(aeq).append(" is correct.").toString());
        agK.a(bg.a.agf);
        bl1.close();
        return;
