...
_L7:
    ...
    private class e
    {
        ...
        public String toString()
        {
            return (new StringBuilder("Positive predicates: ")).append(mr()).append("  Negative predicates: ").append(ms()).append("  Add tags: ").append(mt()).append("  Remove tags: ").append(mu()).append("  Add macros: ").append(mv()).append("  Remove macros: ").append(mA()).toString();
        }
    ...
    private class f
    {
        ...
        public e mB()
        {
            return new e(agZ, aha, ahb, ahc, ahd, ahe, ahf, ahg, ahh, ahi, null);
        }
    ...
    private class c
    {
        ...
        public String toString()
        {
            return (new StringBuilder("Rules: ")).append(mn()).append("  Macros: ").append(agX).toString();
        }
    ...
    private class d
    {
        ...
        public c mp()
        {
            return new c(agW, agX, aeR, agY, null);
        }
