...
public class TagManager
{
    ...
    public static TagManager getInstance(Context context)
    {
        ...
        throw exception;
        aid = new TagManager(context, new _cls2(), new DataLayer(new v(context)));
...
_L2:
        ...
        implements a
    {
        ...
        public final o a(Context context, TagManager tagmanager, Looper looper, String s, int i, r r1)
        {
