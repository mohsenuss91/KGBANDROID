    ...
    implements SafeParcelable
{
    ...
    public boolean equals(Object obj)
    {
        ...
        } else
        {
            ...
            return rO.equals(parcelablecollaborator.rO);
        }
    }
    ...
    {
        return (new StringBuilder("Collaborator [isMe=")).append(Lh).append(", isAnonymous=").append(Li).append(", sessionId=").append(rO).append(", userId=").append(Lj).append(", displayName=").append(Lk).append(", color=").append(Ll).append(", photoUrl=").append(Lm).append("]").toString();
    }
