    ...
    implements SafeParcelable
{
    ...
    public final GroundOverlayOptions position(LatLng latlng, float f)
    {
        ...
        hn.a(flag1, "Position has already been set using positionFromBounds");
        if (latlng != null)
        {
            flag2 = flag;
        } else
        ...
        hn.b(flag2, "Location must be specified");
        if (f < 0.0F)
        {
            flag = false;
        }
    ...
    public final GroundOverlayOptions position(LatLng latlng, float f, float f1)
    {
        ...
        hn.b(flag3, "Width must be non-negative");
        if (f1 < 0.0F)
        {
            flag = false;
        }
    ...
    public final GroundOverlayOptions positionFromBounds(LatLngBounds latlngbounds)
    {
        ...
        aobj = new Object[1];
        aobj[0] = aay;
        hn.a(flag, "Position has already been set using position: %s", aobj);
        aaB = latlngbounds;
        return this;
    }
