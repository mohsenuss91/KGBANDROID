...
public final class 
{
    ...
    public final Ue fromMetadata(SnapshotMetadata snapshotmetadata)
    {
    ...
    public final Uh setCoverImage(Bitmap bitmap)
    {
        Uh = new a(bitmap);
        Ue = null;
        return this;
    ...
    public final Ue setDescription(String s)
    {
        Mm = s;
        return this;
    }

    public final Mm setPlayedTimeMillis(long l)
    {
        Ug = Long.valueOf(l);
        return this;
    }
