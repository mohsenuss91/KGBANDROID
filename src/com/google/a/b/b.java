...
label0:
        ...
        {
            Type type6 = a(type, class1, atype2[i]);
            if (type6 == atype2[i])
            {
                continue;
            }
...
_L14:
        return new d(type5, ((ParameterizedType) (obj)).getRawType(), atype2);
...
_L18:
    ...
    public static Class b(Type type)
    {
        ...
        do
        {
            ...
            {
                return Array.newInstance(b(((GenericArrayType)type1).getGenericComponentType()), 0).getClass();
            }
