...
label0:
    ...
    {
        super.a((Void)obj);
        if (com.appyet.activity.CustomizeActivity.a(c)) goto _L2; else goto _L1
_L1:
...
_L5:
        if (s.trim().length() > 0)
        {
            c.d.add(new c(c, s, null, null, null, null, true, null));
        }
          goto _L6
_L17:
        int l;
...
_L12:
        c c2;
        c.d.add(new c(c, s2, null, null, null, null, true, null));
        c2.g = true;
        String s3 = s2;
_L39:
...
_L14:
        c c3;
        c3 = new c(c, module.getName(), module.getStatusLabel(), module.getType(), module.getModuleId(), module.getIcon(), false, module.getGuid());
        c.d.add(c3);
        l++;
        s1 = s3;
        c2 = c3;
...
_L40:
        ...
        if (!c1.c.equals("Feed")) goto _L24; else goto _L23
_L23:
...
_L25:
        ...
        if (feed.getModuleId() != c1.d.longValue()) goto _L28; else goto _L27
_L27:
        int k = (int)((long)j + feed.getUnreadCount());
          goto _L29
_L26:
        if (c1.b == null) goto _L31; else goto _L30
_L30:
        if (j == 0) goto _L33; else goto _L32
_L32:
        if (c1.b.equals(String.valueOf(j)))
        {
            break MISSING_BLOCK_LABEL_783;
        }
        c1.b = String.valueOf(j);
_L37:
        a = true;
        break MISSING_BLOCK_LABEL_783;
_L31:
