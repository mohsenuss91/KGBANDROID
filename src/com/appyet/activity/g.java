...
final class g extends WebChromeClient
{
    ...
    public g(DisqusCommentActivity disquscommentactivity, DisqusCommentActivity disquscommentactivity1)
    {
        a = disquscommentactivity;
        super();
        g = disquscommentactivity1;
    ...
    public final void onProgressChanged(WebView webview, int j)
    {
        if (j < 100)
        {
            ...
            DisqusCommentActivity.a(a).setProgress(j);
            return;
        } else
        {
