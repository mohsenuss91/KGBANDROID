...
label0:
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && r.b(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
...
_L5:
    ...
    public void setSuggestionsAdapter(a a1)
    {
        mSuggestionsAdapter = a1;
        mQueryTextView.setAdapter(mSuggestionsAdapter);
    }
        ...
        implements android.view.View.OnKeyListener
    {
        ...
        public boolean onKey(View view, int i, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mQueryTextView.isEmpty() && r.b(keyevent))
                {
