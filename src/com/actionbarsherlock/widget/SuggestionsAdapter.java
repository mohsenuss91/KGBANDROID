...
class SuggestionsAdapter extends o
    implements android.view.View.OnClickListener
{
    ...
    private Drawable getDrawable(Uri uri)
    {
        ...
        Drawable drawable1 = getTheDrawable(uri);
        return drawable1;
...
_L3:
    ...
    public CharSequence convertToString(Cursor cursor)
    {
        ...
        if (cursor != null)
        {
            if ((s = getColumnString(cursor, "suggest_intent_query")) != null)
            {
                return s;
            }
        }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charsequence)
    {
        ...
        Cursor cursor = getSuggestions(s, 50);
        if (cursor == null)
        {
