...
class <init>
    implements android.view.rView.Callbacks, android.view.rView.Callbacks, android.widget.r, android.widget.r
{
    ...
    public void onClick(View view)
    {
        if (view == ActivityChooserView.access$800(ActivityChooserView.this))
        {
            ...
            android.content.Intent intent = ActivityChooserView.access$000(ActivityChooserView.this).getDataModel().chooseActivity(i);
            if (intent != null)
            {
                ActivityChooserView.access$700(ActivityChooserView.this).startActivity(intent);
            }
            return;
        }
