    ...
    public ActionBarView(Context context, AttributeSet attributeset)
    {
        ...
        if (mLogo == null)
        {
            if (android.os.Build.VERSION.SDK_INT < 11)
            {
                ...
                {
                    int k = ResourcesCompat.loadLogoFromManifest((Activity)context);
                    if (k != 0)
                    {
...
_L13:
        k5 = getPaddingTop();
        j5 = (getBottom() - getTop() - getPaddingBottom() - k5 - view.getMeasuredHeight()) / 2;
          goto _L12
_L14:
        j5 = j4 + getPaddingTop();
          goto _L12
