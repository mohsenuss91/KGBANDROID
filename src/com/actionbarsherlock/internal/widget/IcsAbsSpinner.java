...
_L5:
        ...
        int j3 = Math.max(i3, getSuggestedMinimumHeight());
        int k3 = Math.max(l2, getSuggestedMinimumWidth());
        int l3;
        int i4;
        if (IS_HONEYCOMB)
        {
            l3 = resolveSizeAndState(j3, j, 0);
            i4 = resolveSizeAndState(k3, i, 0);
        } else
        {
            l3 = resolveSize(j3, j);
            i4 = resolveSize(k3, i);
        }
        setMeasuredDimension(i4, l3);
