    ...
    public float getFloatValue(float f)
    {
        ...
        if (mNumKeyframes == 2)
        {
            if (firstTime)
            {
                ...
                lastValue = ((Keyframe.FloatKeyframe)mKeyframes.get(i)).getFloatValue();
        ...
        if (f <= 0.0F)
        {
            ...
            Keyframe.FloatKeyframe floatkeyframe5 = (Keyframe.FloatKeyframe)mKeyframes.get(i);
        ...
        Keyframe.FloatKeyframe floatkeyframe1;
        for (Keyframe.FloatKeyframe floatkeyframe = (Keyframe.FloatKeyframe)mKeyframes.get(0); i < mNumKeyframes; floatkeyframe = floatkeyframe1)
        {
            floatkeyframe1 = (Keyframe.FloatKeyframe)mKeyframes.get(i);
