    ...
    public int getIntValue(float f)
    {
        ...
        if (mNumKeyframes == 2)
        {
            if (firstTime)
            {
                ...
                lastValue = ((Keyframe.IntKeyframe)mKeyframes.get(i)).getIntValue();
        ...
        if (f <= 0.0F)
        {
            ...
            Keyframe.IntKeyframe intkeyframe5 = (Keyframe.IntKeyframe)mKeyframes.get(i);
        ...
        Keyframe.IntKeyframe intkeyframe1;
        for (Keyframe.IntKeyframe intkeyframe = (Keyframe.IntKeyframe)mKeyframes.get(0); i < mNumKeyframes; intkeyframe = intkeyframe1)
        {
            intkeyframe1 = (Keyframe.IntKeyframe)mKeyframes.get(i);
