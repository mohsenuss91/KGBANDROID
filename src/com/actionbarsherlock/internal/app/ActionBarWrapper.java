    ...
    implements android.app.ActionBar.OnMenuVisibilityListener, android.app.ActionBar.OnNavigationListener
{
    ...
    public ActionBarWrapper(Activity activity)
    {
        boolean flag = true;
        super();
        mMenuVisibilityListeners = new HashSet(flag);
        mActivity = activity;
        ...
        implements android.app.ActionBar.TabListener
    {
        ...
        public void onTabReselected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction fragmenttransaction)
        {
            if (mListener != null)
            {
                ...
                if (flag)
                {
                    fragmenttransaction1 = ((FragmentActivity)mActivity).getSupportFragmentManager().beginTransaction().disallowAddToBackStack();
                }
                mListener.onTabReselected(this, fragmenttransaction1);
                if (fragmenttransaction1 != null && !fragmenttransaction1.isEmpty())
                {
        ...
        public void onTabUnselected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction fragmenttransaction)
        {
            if (mListener != null)
            {
                ...
                {
                    fragmenttransaction1 = ((FragmentActivity)mActivity).getSupportFragmentManager().beginTransaction().disallowAddToBackStack();
                    mFragmentTransaction = fragmenttransaction1;
                }
                mListener.onTabUnselected(this, fragmenttransaction1);
            }
        }
