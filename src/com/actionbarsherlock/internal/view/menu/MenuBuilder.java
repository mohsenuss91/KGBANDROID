        ...
        } else
        {
            ...
            while (iterator.hasNext()) 
            {
                ...
                if (menuitemimpl.isVisible())
                {
                    ...
                    {
                        SubMenu submenu = menu.addSubMenu(menuitemimpl.getGroupId(), menuitemimpl.getItemId(), menuitemimpl.getOrder(), menuitemimpl.getTitle());
                        MenuItemImpl menuitemimpl1;
                        android.view.MenuItem menuitem1;
                        for (Iterator iterator1 = ((SubMenuBuilder)menuitemimpl.getSubMenu()).getVisibleItems().iterator(); iterator1.hasNext(); hashmap.put(menuitem1, menuitemimpl1))
                        {
                            menuitemimpl1 = (MenuItemImpl)iterator1.next();
                            menuitem1 = submenu.add(menuitemimpl1.getGroupId(), menuitemimpl1.getItemId(), menuitemimpl1.getOrder(), menuitemimpl1.getTitle());
...
_L2:
        ...
        flag = flag1 | menuitemimpl.expandActionView();
        if (flag)
        {
            close(true);
            return flag;
...
_L3:
        if (menuitem.hasSubMenu())
        {
            ...
            flag = flag1 | dispatchSubMenuSelected(submenubuilder);
            if (!flag)
            {
                close(true);
                return flag;
