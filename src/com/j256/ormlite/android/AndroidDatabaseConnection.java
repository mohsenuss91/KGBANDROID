...
_L2:
    ...
    {
        Cursor cursor = db.rawQuery((new StringBuilder("SELECT DISTINCT tbl_name FROM sqlite_master WHERE tbl_name = '")).append(s).append("'").toString(), null);
        boolean flag;
...
_L9:
        throw SqlExceptionUtil.create((new StringBuilder("queryForOne from database failed: ")).append(s).toString(), sqlexception1);
        Exception exception1;
        exception1;
_L7:
        if (cursor != null)
