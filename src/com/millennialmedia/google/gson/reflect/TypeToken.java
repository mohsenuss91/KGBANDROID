...
public class TypeToken
{
    ...
    static Type getSuperclassTypeParameter(Class class1)
    {
        ...
        {
            return com.millennialmedia.google.gson.internal..Gson.Types.canonicalize(((ParameterizedType)type1).getActualTypeArguments()[0]);
        }
    }
...
_L2:
    ...
    private static boolean isAssignableFrom(Type type1, ParameterizedType parameterizedtype, Map map)
    {
        ...
        do
        {
            ...
            Class class1 = com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type2);
            ...
            {
                parameterizedtype1 = (ParameterizedType)type2;
            } else
            {
            ...
            if (parameterizedtype1 != null)
            {
                ...
                for (int k = 0; k < atype1.length; k++)
                {
                    ...
                    for (; type4 instanceof TypeVariable; type4 = (Type)map.get(((TypeVariable)type4).getName())) { }
                    map.put(typevariable.getName(), type4);
                }
            ...
            type3 = class1.getGenericSuperclass();
            map = new HashMap(map);
            type2 = type3;
        } while (true);
    }
...
_L4:
    ...
    public boolean isAssignableFrom(Type type1)
    {
        ...
        {
            return rawType.isAssignableFrom(com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type1)) && isAssignableFrom(type1, (GenericArrayType)type);
        } else
        {
