...
public final class ArrayTypeAdapter extends TypeAdapter
{
        ...
        implements TypeAdapterFactory
    {
        ...
        public final TypeAdapter create(Gson gson, TypeToken typetoken)
        {
            ...
            {
                java.lang.reflect.Type type1 = com.millennialmedia.google.gson.internal..Gson.Types.getArrayComponentType(type);
                return new ArrayTypeAdapter(gson, gson.getAdapter(TypeToken.get(type1)), com.millennialmedia.google.gson.internal..Gson.Types.getRawType(type1));
            }
        }
