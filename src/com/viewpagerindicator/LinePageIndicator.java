    ...
    implements c
{
    ...
    {
        this(context, attributeset, e.vpiLinePageIndicatorStyle);
    }
    ...
    public LinePageIndicator(Context context, AttributeSet attributeset, int i1)
    {
        ...
        int j1 = resources.getColor(g.default_line_indicator_selected_color);
        int k1 = resources.getColor(g.default_line_indicator_unselected_color);
        float f1 = resources.getDimension(h.default_line_indicator_line_width);
        float f2 = resources.getDimension(h.default_line_indicator_gap_width);
        float f3 = resources.getDimension(h.default_line_indicator_stroke_width);
        boolean flag = resources.getBoolean(f.default_line_indicator_centered);
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, j.LinePageIndicator, i1, 0);
        ...
        typedarray.recycle();
        i = ap.a(ViewConfiguration.get(context));
    }
...
_L4:
        ...
        return true;
_L6:
        float f3 = w.c(motionevent, w.a(motionevent, k));
        float f4 = f3 - j;
...
_L7:
        ...
        j = w.c(motionevent, l1);
        k = w.b(motionevent, l1);
        return true;
_L8:
        int j1 = w.b(motionevent);
        if (w.b(motionevent, j1) == k)
        {
            int k1 = 0;
            if (j1 == 0)
            {
            ...
            k = w.b(motionevent, k1);
        }
        j = w.c(motionevent, w.a(motionevent, k));
        return true;
    }
